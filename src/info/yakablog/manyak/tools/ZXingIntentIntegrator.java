...
public final class ZXingIntentIntegrator {
   ...
   *
   * @return null if the event handled here was not related to {@link ZXingIntentIntegrator}, or
   *  else an {@link ZXingIntentResult} containing the result of the scan. If the user cancelled scanning,
   *  the fields will be null.
   */
  public static ZXingIntentResult parseActivityResult(int requestCode, int resultCode, Intent intent) {
